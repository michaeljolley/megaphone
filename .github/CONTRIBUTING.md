...
in this project, you agree to abide by our [code of conduct](/.github/CODE_OF_CONDUCT.md).
...
Fork, then clone the repo:
    ...
    git clone git@github.com:your-username/megaphone.git

Push to your fork and [submit a pull request](https://github.com/michaeljolley/megaphone/compare/) against the `main` branch.
